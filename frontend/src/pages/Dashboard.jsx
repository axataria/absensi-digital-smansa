...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="rounded-3xl p-6 sm:p-8 relative overflow-hidden bg-slate-900 text-white border border-slate-800 shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-lg shadow-indigo-600/30 transition-all hover:scale-105"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-white/10 hover:bg-white/20 text-white text-xs font-bold border border-white/20 transition-all"
            >
              Rekapitulasi
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
        {statCards.map((card) => {
          ...
          return (
            <div
              key={card.label}
              className="rounded-3xl p-6 bg-white border border-slate-200 flex flex-col justify-between hover:-translate-y-1 transition-all shadow-2xs"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-3xl p-6 bg-white border border-slate-200 shadow-2xs flex flex-col gap-4">
        ...
        <div className="rounded-3xl p-6 bg-white border border-slate-200 shadow-2xs flex flex-col gap-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div>
